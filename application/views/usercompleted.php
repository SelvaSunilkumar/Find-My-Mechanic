...
<body>
    <?php 
        $details_query = "SELECT * FROM user WHERE id='$userid'";
    ...
    <div class="container">
        <a href="../home/deletedTask" style="padding-left: 10px; padding-top: 15px; padding-bottom: 15px;">Declined Request</a>
    	...
    	<table class="table" id="table">
    		...
    		<tbody>
                <?php 
                    $get_list_query = "SELECT * FROM accomplished WHERE userid='$userid'";
